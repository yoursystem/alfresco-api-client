...
var Promise = require('bluebird')
  ...
  , getThumbnail = require('./api/get-thumbnail')
  , getThumbnailDefinition = require('./api/get-thumbnail-definitions')
...
Alfresco.prototype.getThumbnailPromise = function (nodeRef,thumbnailname) {
  return  getThumbnail(this.get('host'),  this.get('alf_ticket'), nodeRef,thumbnailname);
};
...
Alfresco.prototype.getThumbnailDefinitionsPromise = function (nodeRef) {
  return  getThumbnailDefinition(this.get('host'),  this.get('alf_ticket'), nodeRef);
};

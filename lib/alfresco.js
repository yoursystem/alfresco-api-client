...
Alfresco.prototype.createDocumentPromise = function (node, filePath, fileType) {
  return  createDocumentAPI(this.get('host'),this.get('alf_ticket'), node, filePath, fileType);
};

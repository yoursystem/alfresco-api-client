...
var Promise = require('bluebird')
  ...
  , getChildren = require('./api/get-children')
...
Alfresco.prototype.getChildrenPromise = function (nodeRef) {
  return  getChildren(this.get('host'),  this.get('alf_ticket'), nodeRef);
};
...
Alfresco.prototype.getThumbnailsContentPromise = function (nodeRef) {
  return  getThumbnailsContent(this.get('host'),  this.get('alf_ticket'), nodeRef);
};

...
var Promise = require('bluebird')
  ...
  , siteByshortname = require('./sites/get-site-by-shortname')
  , createFolderAPI = require('./sites/create-folder')
  , cmisCreateDocument = require('./cmis/document-create')
...
Alfresco.prototype.createFolderPromise = function (node, name,title,description) {
...
Alfresco.prototype.createDocumentPromise = function (cmisFolderPath,filePath,fileName) {
  return  createFolderAPI(this.get('host'),this.get('alf_ticket'), cmisFolderPath, filePath,fileName);
};

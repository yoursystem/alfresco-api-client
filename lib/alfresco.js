...
Alfresco.prototype.getThumbnailsContentPromise = function (nodeRef,thumbnailName) {
  return getThumbnailsContent(this.get('host'),  this.get('alf_ticket'), nodeRef , thumbnailName||'doclib');
};
